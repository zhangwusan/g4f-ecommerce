    ...
    <>
      <div className="flex flex-col items-center gap-4">
        <div className="relative group cursor-pointer w-[120px] aspect-square" onClick={handleClick}>
          ...
          <div className="absolute inset-0 bg-opacity-50 rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition">
      ...
      {showCropper && (
        <div
          className="fixed inset-0 bg-opacity-70 z-50 flex items-center justify-center"
          onClick={() => {
            setShowCropper(false);
            setSelectedImage(null);
          }}>
          <div className="relative w-[300px] h-[300px] rounded-lg overflow-hidden" onClick={(e) => e.stopPropagation()}>
            <Cropper
              image={selectedImage!}
              crop={crop}
              zoom={zoom}
          ...
          <button onClick={handleCropDone} className="ml-4 bg-blue-500 px-4 py-2 rounded">
            Crop
          </button>
        </div>
      )}
