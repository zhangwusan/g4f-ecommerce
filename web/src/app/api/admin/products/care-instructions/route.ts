...
export async function GET(request: NextRequest) {
  try {
    ...
    const url = new URL(`${apiBaseUrlV1}/products/care-instructions`);
...
export async function POST(request: NextRequest) {
    try {
        ...
        console.log("POST /care-instruction payload:", payload);
        ...
        console.error("POST /care-instruction error:", error);
        return NextResponse.json({ error: 'Internal Server Error' }, { status: 500 });
    }
}