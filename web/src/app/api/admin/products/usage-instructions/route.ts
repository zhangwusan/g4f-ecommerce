...
export async function GET(request: NextRequest) {
    try {
        ...
        const url = new URL(`${apiBaseUrlV1}/products/usage-instructions`);
...
export async function POST(request: NextRequest) {
    try {
        ...
        console.log("POST /usage-instruction payload:", payload);
        ...
        console.error("POST /usage-instruction error:", error);
        return NextResponse.json({ error: 'Internal Server Error' }, { status: 500 });
    }
}